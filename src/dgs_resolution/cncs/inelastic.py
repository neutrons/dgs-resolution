...
from dgs_resolution.cncs import model as cncsmodel
...
Ei_widget_elements = [
    ...
    dcc.Input(id="cncs_Ei_input", type="number", value=20.0),
]
    ...
    def update_output_div(n_clicks, chopper_select, Ei):
        ...
        try:
            ...
            if (res != res).any():
                ...
                status = ""
                downloadlink = "/download/cncs?chopper_select=%s&Ei=%s" % (chopper_select, Ei)
