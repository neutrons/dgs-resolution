...
from dgs_resolution.arcs import elastic, inelastic
                ...
                """),
                            html.P(
                                [
                                    ...
                                    " ",
                                    html.A(
                                        "the ARCS elastic resolution paper",
                                        href="https://doi.org/10.1016/j.physb.2018.11.027",
                                        target="_blank",
                                    ),
                                ]
                            ),
                            html.P(
                                [
                                    ...
                                    html.A(
                                        "PyChop",
                                        href="https://docs.mantidproject.org/nightly/interfaces/PyChop.html",
                                        target="_blank",
                                    ),
                                ]
                            ),
